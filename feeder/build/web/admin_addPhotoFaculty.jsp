        ...
        <div class="inner-banner-w3ls py-5">
            <div class="container py-xl-5 py-lg-3">
                ...
                <div class="modal-body mt-md-2 mt-5">
                    <h3 class="title-w3 mb-5 text-center text-wh font-weight-bold">Change Photo</h3>
                    <%
                    ...
                    <form action="FacultyController" enctype="multipart/form-data" method="post">
                        ...
                        <button type="submit" name="opn" value="Update" class="btn button-style-w3">Update</button>
                    </form>
                    <%}%>
                </div>
            </div>
